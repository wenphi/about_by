...
L(1) = Revolute('d', 20, 'a', 0, 'alpha', 0,'offset',0 ,...
    'I', [0, 0.35, 0, 0, 0, 0], ...
    'r', [0, 0, 0], ...
    'm', 0, ...
    'Jm', 200e-6, ...
...
L(2) = Revolute('d', 0, 'a', 25, 'alpha', 0, 'offset',0,...
...
L(3) = Revolute('d', 0, 'a', 15, 'alpha', 0,'offset',0,  ...
...
L(4) = Revolute('d', -10, 'a', 0, 'alpha', pi,'offset',0,  ...
...
four = SerialLink(L, 'name', 'four', ...
    'manufacturer', 'Unimation', 'ikine', 'puma');


four.model3d = 'UNIMATE/puma560';

%
% some useful poses
%
qz = [0 0 0 0 ]; % zero angles, L shaped pose
qr = [0 pi/2 -pi/2 0 ]; % ready pose, arm up
qs = [0 0 -pi/2 0 ];
qn=[0 pi/4 pi 0 ];
